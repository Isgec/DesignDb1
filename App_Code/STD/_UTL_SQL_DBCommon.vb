...
Namespace SIS.SYS.SQLDatabase
  Partial Public Class DBCommon
    ...
    Private Shared ReadOnly _banTAString As String = "Data Source=192.9.200.129;Initial Catalog=inforerpdb;Integrated Security=False;User Instance=False;Persist Security Info=True;User ID=lalit;Password=scorpions"
        ...
        Private Shared ReadOnly _VaultString As String = "Data Source=192.9.200.119\autodeskvault;Initial Catalog=BOILER;Integrated Security=False;User Instance=False;Persist Security Info=True;User ID=Sa;Password=Isgec@123"
        Private Shared ReadOnly _perkString As String = "Data Source=192.9.200.150;Initial Catalog=IJTPerks;Integrated Security=False;User Instance=False;Persist Security Info=True;User ID=sa;Password=isgec12345"
    ...
    End Function
        ...
        Public Shared Function GetVaultConnectionString() As String
            Return _VaultString
        End Function
        Public Shared Function GetPerkConnectionString() As String
            Return _perkString
        End Function
